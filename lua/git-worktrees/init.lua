...
---@field wt_path_display? "tilde"|"absolute"|"relative-home"|"relative-wt-base"|"relative-gitdir"|"gitdir"|"gitdir-tilde" How worktree paths are displayed in the picker. (default: "tilde")
